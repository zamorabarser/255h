...
\[  \int_C \langle -y, x,  2z\rangle \cdot ds  \]
\end{exercise}
...
\[   \int_C \langle y^2 + z,  x y,  x - z\rangle \cdot ds  \]
\end{exercise}
...
\[
\int_C \langle 5x - 3,  1 -  z,  2y + 4   \rangle \cdot ds
\]
\end{exercise}
...
\[   \int_C \langle 2y,   -x + z,   y   \rangle \cdot ds   \]
\end{exercise}
...
\begin{exercise}
    ...
    \[    \int_C \langle    x + y , z + x , y + z   \rangle \cdot ds            \]
\end{exercise}
...
\begin{exercise}
    ...
    Which one is larger?
    \[     \int_{C_1} F \cdot ds \,\,\,\,\,\,\,\,\,\,\, \text{ or }    \,\,\,\,\,\,\,\,\,\,\,          \int_{C_2} F \cdot ds      \]
\end{exercise}
