...
\begin{exercise}  
    ...
    Compute
    \[    \int_C \langle  - y , x + 2 , z + 1  \rangle \cdot  d \gamma       \]
\end{exercise}
...
\begin{exercise}  
    ...
    Compute
    \[    \int_C \langle   x  + y ,  y + z , z + x \rangle \cdot  d \gamma       \]
\end{exercise}
...
\begin{exercise}
    ...
    \[    \int_C  \langle e^{x^2} , \sin  (y^2) , \cos (z^3) \rangle \cdot  d \gamma        \]
\end{exercise}
...
\begin{exercise}
    ...
    \[    \int_C   \langle  x + z , \cos y , e^z + x  \rangle  \cdot  d \gamma       \]
\end{exercise}
...
\begin{exercise}
    ...
    Compute 
    \[    \int_C \langle   e ^x (z-1) , z \cos y , e ^x + \sin y   \rangle  \cdot  d \gamma       \]
\end{exercise}
