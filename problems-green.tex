...
\begin{exercise}
    ...
    \begin{hint}
    The curve is closed and travels clockwise, so the integral above equals the integral of $ 3 -2 = 1 $ (minus the curl of $\langle 3 y + x^2 - 2,  2x + y + 7 \rangle  $) over the region surrounded by $C$. 
\end{hint}
\end{exercise}
\begin{exercise}
...
\begin{exercise}
    ...
    \begin{hint}
        ...
        \[      \int_{C_1} F \cdot d_{\gamma _1} - \int_{C_3} F \cdot d _{\gamma _3} = \iint_{D} \text{curl}(F) \, dA                     \]
